            ...
            <div className="grid h-10 w-10 place-items-center rounded-lg bg-white shadow-sm">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path
                  ...
                  strokeWidth="2"
                />
                <path d="M14 3v4a2 2 0 0 0 2 2h4" stroke="#5A9BD5" strokeWidth="2" />
              </svg>
            </div>
...
function CardArticolo({ titolo, data, abstract, autori, cta, href }) {
  return (
    <CardBase>
      ...
      <a
        href={href}
        className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-md bg-[#5A9BD5] px-4 py-3 text-sm font-semibold text-white hover:brightness-95"
      >
